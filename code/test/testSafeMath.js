...
contract('SafeMath', function () {
  ...
  describe('add', function () {
    ...
    it('throws a revert error on addition overflow', async function () {
      ...
      await AssertRevert.assertRevert(this.safeMath.add(a, b));
    });
  });
  ...
  describe('sub', function () {
    ...
    it('throws a revert error if subtraction result would be negative', async function () {
      ...
      await AssertRevert.assertRevert(this.safeMath.sub(a, b));
    });
  });
  ...
  describe('mul', function () {
    ...
    it('throws a revert error on multiplication overflow', async function () {
      ...
      await AssertRevert.assertRevert(this.safeMath.mul(a, b));
    });
  });
  ...
  describe('div', function () {
    ...
    it('throws a revert error on zero division', async function () {
      ...
      await AssertRevert.assertRevert(this.safeMath.div(a, b));
    });
  });
  ...
  describe('mod', function () {
    ...
    it('reverts with a 0 divisor', async function () {
      ...
      await AssertRevert.assertRevert(this.safeMath.mod(a, b));
    });
  });
});
